...
export function buildOnboardingInstructions(): string {
  return [
    ...
    "Replace [name] with the user's name and [your name] with the name you were given in Step 1.",
    'Keep the domain list and bullet list exactly as written. The personality chosen in Step 3',
    'is not mentioned in this message — it only affects your tone in later replies.',
    'Do NOT run /self-customize until AFTER this message is sent.',
    '',
    '---',
    'Hi [name]! My name is [your name]. I am here to be your learning assistant for the 4 domains:',
    '- Healthcare Policy',
    '- Standards',
    '- Governance',
    '- Deeplearning AI',
    '',
    'My primary focus is to help you master and retain these core topics. In addition to our structured courses, I can also perform the following supporting functions:',
    '• Send up to date corporate communication news',
    '• Answer questions regarding your private documents',
    '• Generate slides and do research on topics',
    '',
    "Let's begin our learning adventure! What would you like to learn or refresh your memory about today?",
    '---',
    '',
